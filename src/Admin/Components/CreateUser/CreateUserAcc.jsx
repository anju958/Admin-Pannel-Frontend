...
//     hr: ["Job Opening", "Employees", "Attendance", "Leave"],
//     account: ["Invoices", "Payroll", "Reports"]
//   };
...
//   function handlePermissionChange(module, action, checked) {
//     setForm(prev => {
//       const modPerm = prev.permissions[module] || [];
//       return {
//         ...prev,
//         permissions: {
//           ...prev.permissions,
...
//   function handleSelectAll(module) {
//     setForm(prev => ({
//       ...prev,
...
//   function handleDeselectAll(module) {
//     setForm(prev => ({
//       ...prev,
...
//           <h4 className="mb-0">{editUser ? "Edit User Account" : "Create New User"}</h4>
//         </div>
...
//                 <h5 className="text-primary mb-3">{form.role.charAt(0).toUpperCase() + form.role.slice(1)} Permissions</h5>
//                 {departmentModules[form.role]?.map((module, i) => (
//                   <div className="mb-4" key={i}>
//                     <div className="d-flex align-items-center mb-2">
//                       <h6 className="me-2 mb-0 text-muted">{module}</h6>
//                       <button type="button" className="btn btn-outline-success btn-xs me-1 btn-sm" onClick={() => handleSelectAll(module)}>Select All</button>
//                       <button type="button" className="btn btn-outline-secondary btn-xs btn-sm" onClick={() => handleDeselectAll(module)}>Deselect All</button>
//                     </div>
//                     <div className="d-flex flex-wrap">
//                       {actions.map((action, j) => (
//                         <div className="form-check form-switch me-3 mb-2" key={j}>
//                           <input
...
//                           />
//                           <label className="form-check-label" htmlFor={`${module}-${action}`}>{action}</label>
//                         </div>
//                       ))}
//                     </div>
//                   </div>
...
//             <button type="submit" className="btn btn-primary px-4 shadow">{editUser ? "Update User" : "Create User"}</button>
//           </div>
//         </form>
//       </div>
//     </div>
